...
public class ShadowChunk13_R1 implements ShadowChunk
{
	...
	public ShadowChunk13_R1(org.bukkit.Chunk chunk)
	{
		this.chunk = chunk;
	...
	{
		nmsCopy.getBiomeIndex()[(z & 15) << 4 | x & 15] = BiomeBase.a(id);
		biomeModified = true;
	}
	...
	{
		@SuppressWarnings("deprecation")
		IBlockData d = Block.getById(type).getBlockData();
		int section = y >> 4;
